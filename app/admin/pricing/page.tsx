        ...
        <div className="space-y-8">
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {packages.map((pkg) => (
                        <div key={pkg._id} className="p-8 rounded-3xl bg-zinc-900 border border-zinc-800 relative group">
                            ...
                            {pkg.popular && (
                                <span className="inline-block px-3 py-1 rounded-full bg-red-600 text-[10px] font-black uppercase tracking-tighter mb-4">
                                    {pkg.badge || 'Popular'}
                                </span>
                            )}
                            <h4 className="text-2xl font-black mb-1">{pkg.name}</h4>
                            <p className="text-4xl font-black text-white mb-6">₹{pkg.price}</p>
